...
export default function CertificateCard({ certificate }) {
  ...
  // Phase 10 — Phase 9's certificate GET/list endpoints resolve this live
  // (null for pre-Phase-9 certificates or a Learning Instance with no
  // academic structure — both remain valid, undated-by-period
  // certificates, not an error). Showing it here is what lets a learner
  // tell two same-module certificates from different periods apart.
